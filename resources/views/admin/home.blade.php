...
<div class="row">
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-danger-200 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    {{ $data->total_flavour_categories }}
                    <small class="m-0 l-h-n">Total Flavour Categories</small>
                </h3>
            </div>
            <i class="fal fa-amp-guitar position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4" style="font-size: 6rem;"></i>
        </div>
    </div>
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-info-200 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    {{ $data->total_flavours }}
                    <small class="m-0 l-h-n">Total Flavours</small>
                </h3>
            </div>
            <i class="fal fa-apple-crate position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4" style="font-size: 6rem;"></i>
        </div>
    </div>
</div>
<div class="row">
