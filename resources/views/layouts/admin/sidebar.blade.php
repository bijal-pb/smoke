...
<aside class="page-sidebar">
    <div class="page-logo">
        <a href="<?= URL::to('admin'); ?>" class="page-logo-link press-scale-down d-flex align-items-center position-relative">
            <img src="{{ URL::asset('admin_assets/img/logo.png')}}" alt="Sebtember" aria-roledescription="logo">
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li class="{{ request()->is('admin/users')  ? 'active' : '' }}">
                <a href="<?= URL::to('admin/users'); ?>"" title="Users" data-filter-tags="user">
                    <i class="fal fa-user"></i>
                    <span class="nav-link-text" data-i18n="nav.users">Users</span>
                </a>
            </li>
            <li class="{{ request()->is('admin/category')  ? 'active' : '' }}">
                <a href="<?= URL::to('admin/category'); ?>"" title="Categories" data-filter-tags="category">
                    <i class="fal fa-cubes"></i>
                    <span class="nav-link-text" data-i18n="nav.categories">Categories</span>
                </a>
            </li>
            <li class="{{ request()->is('admin/flavour/category')  ? 'active' : '' }}">
                <a href="<?= URL::to('admin/flavour/category'); ?>"" title="Flavour Categories" data-filter-tags="flavour category">
                    <i class="fal fa-amp-guitar"></i>
                    <span class="nav-link-text" data-i18n="nav.flavour cateory">Flavour Categories</span>
                </a>
            </li>      
            <li class="{{ request()->is('admin/flavour')  ? 'active' : '' }}">
                <a href="<?= URL::to('admin/flavour'); ?>"" title="Flavours" data-filter-tags="flavours">
                    <i class="fal fa-apple-crate"></i>
                    <span class="nav-link-text" data-i18n="nav.flavours">Flavours</span>
                </a>
            </li>   
            
            <li class="{{ request()->is('admin/post')  ? 'active' : '' }}">
                <a href="<?= URL::to('admin/post'); ?>"" title="Posts" data-filter-tags="post">
                    <i class="fal fa-id-badge"></i>
                    <span class="nav-link-text" data-i18n="nav.posts">Posts</span>
                </a>
            </li>   
            <li class="{{ request()->is('admin/setting')  ? 'active' : '' }}">
                <a href="<?= URL::to('admin/setting'); ?>"" title="App Setting" data-filter-tags="setting">
